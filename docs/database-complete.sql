...
-- 2. Seed data (admin user, roles, permissions, menus, groups)
-- 3. Admin menu permissions fix
-- 4. Menu hierarchy verification queries
--
-- Cách sử dụng:
-- 1. Tạo database: CREATE DATABASE Core;
-- 2. Chạy file này: mysql -u root -p Core < database-complete.sql
--
-- ⚠️ LƯU Ý QUAN TRỌNG:
...
-- ============================================
-- PHẦN 3: FIX ADMIN MENU PERMISSIONS
-- Thêm menu permissions cho user admin
-- ============================================
-- Gán permission cho menu Settings (parent menu)
...
-- ============================================
-- Gán permission cho submenu "Role Menu Permissions"
...
-- ============================================
-- MENU PERMISSIONS FOR ADMIN USER
-- ============================================
